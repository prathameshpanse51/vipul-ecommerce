...
const stripePromise = loadStripe(
  "pk_test_51PtuVLRqnw3uDiGrSzjImPcq9lwLn5BykxwMEacjH74JDLVzqxekhOA83UHlST63TNyc6banrzDHYTlYg5g6K8Po00UMJOFmd7"
);
//Redux
...
const Checkout = () => {
  ...
  useEffect(() => {
    ...
    // http://localhost:4242/
    fetch(
      "https://vipul-ecommerce-backend.onrender.com/create-payment-intent",
      {
        method: "POST",
